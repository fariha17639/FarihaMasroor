...
A collection of database design projects showcasing **Entity Relationship (ER) modeling**, **database normalization**, and **Star Schema design**. The portfolio includes healthcare and restaurant management systems along with a dimensional model for marketing campaign analytics.

**Projects Included**
- Healthcare Management Database
- Restaurant Management Database
- Marketing Campaign Star Schema
